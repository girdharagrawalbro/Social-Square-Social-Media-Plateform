...
function AppInit() {
    ...
    useEffect(() => {
        ...
        const flushBatch = () => {
            ...
            if (secsToSend >= 10) {
                ...
                api.post(`${import.meta.env.REACT_APP_NGINIX === 'true' ? '' : import.meta.env.REACT_APP_BACKEND_URL}/api/activity/time-spent`, { durationSeconds: secsToSend })
                    .catch(() => { });
            }
        };
    ...
    useEffect(() => {
        ...
        // Initialize E2EE (loads local keys silently)
        useE2eeStore.getState().initE2ee(user._id).catch(err => {
