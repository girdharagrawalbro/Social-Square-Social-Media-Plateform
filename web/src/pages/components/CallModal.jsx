...
const CallModal = ({
    ...
    const [provider, setProvider] = useState(import.meta.env.REACT_APP_CALL_PROVIDER || CALL_PROVIDERS.WEBSOCKET);
    const [liveKitUrl, setLiveKitUrl] = useState(import.meta.env.REACT_APP_LIVEKIT_URL || 'ws://localhost:7880');
    ...
    useEffect(() => {
        ...
        const setupCallingSession = async () => {
            try {
                ...
                const resolvedProvider = import.meta.env.REACT_APP_CALL_PROVIDER || providerRes.data?.provider || CALL_PROVIDERS.WEBSOCKET;
