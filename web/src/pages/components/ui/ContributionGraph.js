...
const ContributionGraph = ({ contributions = {} }) => {
    ...
    return (
        <div>
            <details>
                <summary className='text-xs justify-center font-black uppercase text-[var(--text-sub)] tracking-widest flex items-center gap-1.5'> <i className="pi pi-calendar text-[11px] text-[#808bf5]"></i> Consistency Graph</summary>
