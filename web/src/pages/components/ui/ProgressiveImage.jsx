...
const optimizeCloudinaryUrl = (url) => {
    ...
    if (url.includes('cloudinary.com') && url.includes('/upload/') && !url.includes('f_auto') && !url.includes('q_auto')) {
...
const ProgressiveImage = ({
    ...
    useEffect(() => {
        ...
        const load = async () => {
            let finalSrc = optimizeCloudinaryUrl(src);
            if (fileKey && iv && src) {
    ...
    return (
        ...
        >
            ...
            <img
                src={currentSrc || optimizeCloudinaryUrl(src)}
                alt={alt}
                draggable={false}
