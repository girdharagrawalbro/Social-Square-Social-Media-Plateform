                ...
                {sent ? (
                    <div className="animate-in fade-in zoom-in duration-500 mt-4">
                        ...
                        <p className={`text-sm mb-6 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                            If an account existes for this email, you'll rececive a password rest link shortly
                            <br />
                            <br />
                    ...
                    <form onSubmit={handleSubmit} className="mt-4">
                        ...
                        <div className={`pt-6 border-t ${isDark ? 'border-gray-800' : 'border-gray-100'}`}>
                            <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
                                Remember your password? <Link to="/login" className="text-[#808bf5] font-bold hover:underline">Sign in</Link>
                            </p>
                        </div>
                    </form>
                )}
