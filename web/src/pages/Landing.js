...
import scene2 from '../assets/promo/scene_2.png';
...
const Landing = () => {
    ...
    return (
        <>
            ...
            <main className="bg-slate-50 text-slate-800 dark:bg-neutral-950 dark:text-neutral-200 transition-colors duration-300">
                {/* Hero Section */}
                    ...
                    <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-16 z-10">
                        <div className="space-y-6 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                                <Link to="/signup" className="bg-indigo-600 text-white px-10 py-4 rounded-full font-bold hover:bg-indigo-700 dark:hover:bg-indigo-500 transition-all transform active:scale-95 shadow-md shadow-indigo-200 dark:shadow-none text-center">
                                    Get Started
                                </Link>
                                <Link to="/login" className="border border-slate-300 dark:border-neutral-700 text-slate-700 dark:text-neutral-300 bg-white dark:bg-neutral-900 px-10 py-4 rounded-full font-bold hover:bg-slate-50 dark:hover:bg-neutral-800 transition-all transform active:scale-95 text-center">
                                    Sign In
                                </Link>
                            </div>
                ...
                <section className="py-20 bg-white dark:bg-neutral-900 border-y border-slate-100 dark:border-neutral-800 transition-colors duration-300">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16 max-w-2xl mx-auto">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">Why Choose Social Square?</h2>
                ...
                <section className="py-20 overflow-hidden bg-slate-50 dark:bg-neutral-950">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            ...
                            <div className="lg:w-1/2 order-1 lg:order-2 grid grid-cols-2 gap-4">
                                <div className="space-y-4 pt-12">
                                    <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg transform -rotate-3 hover:rotate-0 transition-transform duration-500 border border-slate-200/60 dark:border-neutral-800">
                                        <img src={scene7} alt="Minimalist social design art" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="aspect-square rounded-2xl overflow-hidden shadow-lg transform rotate-2 hover:rotate-0 transition-transform duration-500 border border-slate-200/60 dark:border-neutral-800">
                                        <img src={scene2} alt="Sophisticated social space" className="w-full h-full object-cover" />
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    <div className="aspect-square rounded-2xl overflow-hidden shadow-lg transform rotate-6 hover:rotate-0 transition-transform duration-500 border border-slate-200/60 dark:border-neutral-800">
                                        <img src={scene8} alt="Premium user experience" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg transform -rotate-2 hover:rotate-0 transition-transform duration-500 border border-slate-200/60 dark:border-neutral-800">
                                        <img src={scene3} alt="Social Square frontier" className="w-full h-full object-cover" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="bg-gradient-to-br from-[#667eea] to-[#764ba2] rounded-[2rem] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
                            <div className="relative z-10 space-y-6 max-w-3xl mx-auto">
                                ...
                                <div className="pt-4">
                                    <Link to="/signup" className="inline-block bg-white text-indigo-600 dark:bg-neutral-900 dark:text-white px-10 py-4 rounded-full font-bold hover:bg-slate-50 dark:hover:bg-neutral-800 transition-all transform active:scale-95 shadow-md shadow-black/10">
                                        Become a Member
                                    </Link>
                                </div>
                            </div>
