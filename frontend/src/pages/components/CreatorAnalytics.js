    ...
    return (
        <div className="flex flex-col gap-8 pb-10">
            ...
            <div className="grid grid-cols-2 gap-4 px-1">
                ...
                <div className="relative overflow-hidden group bg-gradient-to-br from-pink-500/10 to-purple-500/10 p-5 rounded-3xl border border-pink-500/20 backdrop-blur-lg transition-all hover:scale-[1.02]">
