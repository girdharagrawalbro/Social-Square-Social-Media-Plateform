...
//   try {
//     const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/auth/get`, {
//       method: 'GET',
//       headers: {
...
//   try {
//     const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/auth/other-users`, {
//       method: 'GET',
//       headers: {
...
//   try {
//     const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/auth/follow`, {
//       method: "POST",
//       headers: {
...
//   try {
//     const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/auth/unfollow`, {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
//   try {
//     const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/auth/search`, {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
// export default dataSlice.reducer;// ⚠️ Redux has been removed. This file is a compatibility stub.
