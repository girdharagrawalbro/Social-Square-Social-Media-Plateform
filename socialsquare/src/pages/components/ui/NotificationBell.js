...
export default function NotificationBell({ userId }) {
    ...
    return (
        <div ref={ref} style={{ position: 'relative' }}>
            ...
            <Dialog header="Notifications & Collabs" visible={open} style={{ width: '360px' }} onHide={() => setOpen(false)} modal={false} closable={false} draggable={false} resizable={false} contentStyle={{ padding: 0 }}>
