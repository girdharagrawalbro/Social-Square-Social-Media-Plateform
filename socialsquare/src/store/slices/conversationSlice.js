...
export const createConversation = createAsyncThunk(
    ...
    async ({ participants }, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.post('https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/create', {
                participants,
            });
...
export const fetchConversations = createAsyncThunk(
    ...
    async (userId, { rejectWithValue }) => {
        try {
            const response = await axios.get(`https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/${userId}`);
            return response.data;
        } catch (error) {
...
export const fetchMessages = createAsyncThunk(
    ...
    async ({ participantIds }, { rejectWithValue }) => {
        try {
            ...
            const response = await fetch(`https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/messages`, {
                method: "POST",
                headers: {
...
export const createMessage = createAsyncThunk(
    ...
    async ({ conversationId, sender, content, senderName, recipientId }, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/messages/create', {
                conversationId,
                sender,
                content,
                recipientId,
...
export const markMessagesAsRead = createAsyncThunk(
    ...
    async ({ unreadMessageIds, lastMessage }, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/messages/mark-read', { unreadMessageIds, lastMessage });
            return response.data;
        } catch (error) {
            return rejectWithValue(error.response.data);
        }
...
export const getNotifications = createAsyncThunk(
    ...
    async (userId, { rejectWithValue }) => {
        try {
            const response = await axios.get(`https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/notifications/${userId}`);
...
export const readNotifications = createAsyncThunk(
    ...
    async (Ids, { rejectWithValue }) => {
        try {
            const response = await axios.patch('https://social-square-social-media-plateform-uwd8.onrender.com/api/conversation/notifications/mark-read', { Ids });
            return response.data;
        }
        catch (error) {
            return rejectWithValue(error.response.data)
