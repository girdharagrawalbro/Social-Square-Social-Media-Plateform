...
//             const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/create`, {
//                 participants,
//             });
...
//         try {
//             const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/${userId}`);
//             return response.data;
//         } catch (error) {
...
//             const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/messages`, {
//                 method: "POST",
//                 headers: {
...
//         try {
//             const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/messages/create`, {
//                 conversationId,
//                 sender,
//                 content,
//                 recipientId,
...
//         try {
//             const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/messages/mark-read`, { unreadMessageIds, lastMessage });
//             return response.data;
//         } catch (error) {
//             return rejectWithValue(error.response.data);
//         }
...
//     async (userId, { rejectWithValue }) => {
//         try {
//             const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/notifications/${userId}`);
...
//         try {
//             const response = await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/api/conversation/notifications/mark-read`, { Ids });
//             return response.data;
//         }
//         catch (error) {
//             return rejectWithValue(error.response.data)
